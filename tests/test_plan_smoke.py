...
class HollandPlanSmokeTests(unittest.TestCase):
    ...
    def test_health_reports_ready_for_core_contract(self):
        ...
        self.assertTrue(payload["technical_ready"], payload)
        self.assertTrue(payload["core_contract_ready"], payload)
        self.assertFalse(payload["consulting_ready"], payload)
        ...
        self.assertIn("consulting_checks", payload)
        self.assertFalse(payload["consulting_checks"]["occupation_bridge_riasec_coverage"])
        self.assertEqual(payload["readiness_levels"]["core_contract_ready"], payload["ready_for_core"])
